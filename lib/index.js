...
(function() {
  var MarkdownParser, YParser, bnf, grammar,
  ...
  MarkdownParser = (function(_super) {
    ...
    MarkdownParser.prototype.generateGrammar = function() {
      var gram, parser;
      gram = new YParser.GrammarParser;
      gram.loadString(bnf);
      parser = gram.loadGrammar();
      return this.grammars = parser.grammars;
    };

    MarkdownParser.prototype.printGrammar = function() {
      return console.log("module.exports = " + (JSON.stringify(this.grammars)));
    };
    ...
    MarkdownParser.prototype.processList = function(list, id) {
      ...
      while (list.nodes[id] != null) {
        ...
        if (node.level.length > lastLevel.length) {
          ...
          newList.nodes.slice(-1)[0].nodes.push(ret[0]);
          id = ret[1];
          continue;
        }
